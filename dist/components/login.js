...
var Login = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Login() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Login.__proto__ || Object.getPrototypeOf(Login)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["visible"], _this.onGetUserInfo = function (e) {
      var _this$props = _this.props,
          onCancel = _this$props.onCancel,
          onReloadUserInfo = _this$props.onReloadUserInfo;
  ...
  _createClass(Login, [{
    ...
    value: function _createData() {
      ...
      var visible = this.__props.visible;
...
}, _class.$$events = ["onGetUserInfo"], _class.defaultProps = {
  visible: false
}, _temp2);
